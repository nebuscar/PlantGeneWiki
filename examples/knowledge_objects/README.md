...
These files are not raw data. They are API-shaped knowledge objects, relations, datasets, and evidence claims that can be rebuilt from real normalized data later.
