...
class StaticWebPageTests(unittest.TestCase):
    ...
    def test_gene_page_uses_genecards_like_card_structure(self):
        ...
        self.assertIn('Publications for Atha01G0000010', html)
        self.assertIn('Review Publications for Atha01G0000010', html)
        self.assertIn('External literature databases for Atha01G0000010', html)
        self.assertIn('Literature normalization pending', html)
        self.assertNotIn('Evidence Records for Atha01G0000010', html)
        self.assertIn('Chr1:3631-5899', html)
        self.assertIn('1-based-closed', html)
        self.assertNotIn('Pending GFF/GTF normalization', html)
